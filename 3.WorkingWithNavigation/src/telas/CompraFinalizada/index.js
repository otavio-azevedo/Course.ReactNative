...
import CompraFinalizadaImage from '../../assets/compra-finalizada.png';
...
export default function CompraFinalizada() {
    ...
    return <View style={estilos.tela}>
        ...
        <View style={estilos.conteudo}>
            <Image source={CompraFinalizadaImage} style={estilos.sucesso} />
                ...
                <TouchableOpacity
                    ...
                    onPress={() =>
                        navigation.navigate('HomeScreen',
                            { compra: { nome: nomeCompra, timestamp: + new Date() } })
                    }>
